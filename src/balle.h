...
/*! \class balle
* \brief classe représentant les balles tiré par le joueur
*/
class balle : public objet
{
private:
    Complex *posInit; ///< position initiale de la balle
    Complex *vit;     ///< vitesse(direction) de la balle
    double angle;     ///< angle de rotation de l'image de la balle
    float f;          ///< vitesse de deplacement de la balle
